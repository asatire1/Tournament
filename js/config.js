...
const CONFIG = {
    ...
    // Groups + Knockout Mode (24 players)
    GROUPS_MODE: {
        PLAYER_COUNT: 24,
        GROUP_COUNT: 4,
        PLAYERS_PER_GROUP: 6,
        GROUP_MATCHES_PER_PLAYER: 5,  // Partner with everyone in group once
        DEFAULT_POINTS: 32,           // First to 32 points
        MIN_GAMES: 6,                 // Group (5) + at least QF (1)
        MAX_GAMES: 8,                 // Group (5) + QF + SF + Final
        COURTS_PER_GROUP: 1           // 1 court per group = 4 courts total
    }
};
