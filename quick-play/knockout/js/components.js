        ...
        <div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50">
            ...
            <div class="max-w-6xl mx-auto px-4 py-6">
                ...
                <div class="mt-4 flex flex-wrap gap-2 justify-center">
                    <button onclick="ResultCard.share(getCardData(), 'landscape')" class="inline-flex items-center gap-2 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium rounded-xl transition-colors shadow-sm">
...
function render() {
    ...
    setTimeout(function() {
        if (typeof ResultCard !== 'undefined' && typeof getCardData === 'function') {
            var s = TournamentState.getState();
            if (s && s.meta && s.meta.status === 'complete') {
