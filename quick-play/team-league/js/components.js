                ...
                return `
                    <div class="partner-card">
                        <div class="partner-card-header ${colourClass}">
                            ...
                            <span class="team-name-header">${escapeHtml(team.name)}</span>
                        </div>
                        <div class="partner-card-body">
                            <div class="players-list">
                                <div class="player-row">
                                    <span class="player-name">${escapeHtml(team.player1Name)}</span>
                                    <span class="player-rating">${team.player1Rating.toFixed(1)}</span>
                                </div>
                                <div class="player-row">
                                    <span class="player-name">${escapeHtml(team.player2Name)}</span>
                            ...
                            <div class="p-4 bg-purple-50 rounded-xl border-2 border-purple-300">
                                ...
                                <div class="grid gap-3 md:grid-cols-2">
                                    <div>
                                        ...
                                        <input type="text" id="edit-p1-name-${team.id}" value="${escapeHtml(team.player1Name)}" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-purple-500 focus:outline-none" />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="edit-p2-name-${team.id}" value="${escapeHtml(team.player2Name)}" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-purple-500 focus:outline-none" />
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-gray-600 mb-1">Rating</label>
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text" id="edit-team-name-${team.id}" value="${escapeHtml(team.name)}" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-purple-500 focus:outline-none" />
                                </div>
