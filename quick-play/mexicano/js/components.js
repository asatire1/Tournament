...
function renderStandingsTab() {
    ...
    return `
        ...
        <div class="mt-4 flex flex-wrap gap-2 justify-center">
            <button onclick="ResultCard.share(getCardData(), 'landscape')" class="inline-flex items-center gap-2 px-4 py-2 bg-teal-500 hover:bg-teal-600 text-white text-sm font-medium rounded-xl transition-colors shadow-sm">
