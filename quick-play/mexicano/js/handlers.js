...
function showShareModal() {
    ...
    const shareButtonsHTML = typeof SocialShare !== 'undefined' ? SocialShare.getShareButtons(state.tournamentName || 'Mexicano', state.tournamentId, 'mexicano', playerLink, standings) : '';
