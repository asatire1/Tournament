    ...
    return `
        <div class="group-card">
            ...
            <div class="mt-4 flex flex-wrap gap-2 justify-center">
                <button onclick="ResultCard.share(getCardData(), 'landscape')" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-medium rounded-xl transition-colors shadow-sm">
                            ...
                            <div class="p-4 bg-emerald-50 rounded-xl border-2 border-emerald-300">
                                ...
                                <div class="grid gap-3 md:grid-cols-2">
                                    <div>
                                        ...
                                        <input type="text" id="edit-p1-name-${team.id}" value="${escapeHtml(team.player1Name)}" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-emerald-500 focus:outline-none" />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="edit-p2-name-${team.id}" value="${escapeHtml(team.player2Name)}" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-emerald-500 focus:outline-none" />
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-gray-600 mb-1">Rating</label>
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text" id="edit-team-name-${team.id}" value="${escapeHtml(team.name)}" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-emerald-500 focus:outline-none" />
                                </div>
...
function renderRoundRobin() {
    ...
    setTimeout(function() {
        if (typeof ResultCard !== 'undefined' && typeof getCardData === 'function') {
            ...
            fixtures.forEach(function(round) {
                (round.matches || []).forEach(function(match) {
                    total++;
                    var score = state.getScore ? state.getScore(match.team1Id, match.team2Id) : {};
                    if (score && score.team1Score != null && score.team2Score != null) completed++;
                });
            });
