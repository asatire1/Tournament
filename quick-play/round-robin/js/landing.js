...
async function renderLandingPage() {
    ...
    if (typeof AuthService !== 'undefined') {
        try {
            ...
            console.log('Round Robin landing - current user:', currentUser);
        } catch (e) {
            ...
            <div class="max-w-6xl mx-auto px-4 py-3">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3 md:gap-6">
                        <a href="../../index.html#quick-play" class="text-emerald-600 font-semibold text-sm md:text-base">Quick Play</a>
                        <a href="../../competitions/browse.html" class="text-gray-600 hover:text-emerald-600 font-medium text-sm md:text-base transition-colors">Competitions</a>
    ...
    if (typeof AuthService !== 'undefined') {
        AuthService.onAuthStateChanged((user) => {
            console.log('Round Robin - auth state changed:', user);
