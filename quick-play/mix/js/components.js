...
function MatchCard(round, matchIdx, match, displayRound = null) {
    ...
    return `
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ${matches.map(m => MatchCard(m.round, m.idx, m.match, m.displayRound)).join('')}
            </div>
    ...
    return `
        <div class="space-y-6">
            ...
            <div class="mt-4 flex flex-wrap gap-2 justify-center">
                <button onclick="ResultCard.share(getCardData(), 'landscape')" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium rounded-xl transition-colors shadow-sm">
