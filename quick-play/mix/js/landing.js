        ...
        if (user) {
            ...
            return `
                <a href="../../account/profile.html" class="flex items-center gap-2 text-gray-600 hover:text-blue-600 font-medium text-sm transition-colors">
                    <span class="w-8 h-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-bold">${initial}</span>
            ...
            <div class="max-w-6xl mx-auto px-4 py-3">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3 md:gap-6">
                        ...
                        <a href="../../competitions/browse.html" class="text-gray-600 hover:text-blue-600 font-medium text-sm md:text-base transition-colors">Competitions</a>
