/**
 * Uber Padel Internal Bug Reporter — Standalone (no bundler required)
...
.fb-submit{padding:8px 20px;border:none;border-radius:8px;background:#7c3aed;font-size:14px;color:#fff;cursor:pointer;font-weight:500;transition:background .15s}
