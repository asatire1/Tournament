 ...
 */
export function kFactor(confidence) {
 ...
 */
export function updateConfidence(currentConfidence) {
 ...
 */
export function applyInactivityDecay(confidence, monthsInactive) {
 ...
 */
export function processDoublesMatch({ team1, team2 }) {
 ...
 * @returns {boolean}
 */
export function isSuspiciousChange({ before, after, gamesPlayed }) {
 ...
 */
export function monthsSince(lastPlayedAt) {
